        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-4">
                        <a href="{{ route('complaints.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Register Complaint</a>
                    </div>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach ($complaints as $complaint)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $complaint->address }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $complaint->product }}</td>
